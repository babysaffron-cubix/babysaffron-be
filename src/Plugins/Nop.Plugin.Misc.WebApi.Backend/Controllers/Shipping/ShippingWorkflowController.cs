...
public partial class ShippingWorkflowController : BaseNopWebApiBackendController
{
    ...
    [ProducesResponseType(typeof(string), StatusCodes.Status404NotFound)]
    [ProducesResponseType(typeof(GetShippingOptionResponseDto), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
        ...
        [FromQuery] int storeId = 0)
    {
        ...
        var response = result.ToDto<GetShippingOptionResponseDto>();
    ...
    /// <param name="storeId">Load records allowed only in a specified store; pass 0 to load all records</param>
    [HttpGet("{addressId}")]
    [ProducesResponseType(typeof(GetPickupPointsResponseDto), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
        ...
        [FromQuery] int storeId = 0)
    {
        ...
        var response = result.ToDto<GetPickupPointsResponseDto>();
