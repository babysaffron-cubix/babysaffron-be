...
public partial class GenericAttributeController : BaseNopWebApiBackendController
{
    ...
    public virtual async Task<IActionResult> DeleteAttributes(string ids)
    {
        ...
        var categories = await _genericAttributeRepository.GetByIdsAsync(attributesId);
    ...
    public virtual async Task<IActionResult> Delete(int id)
    {
        ...
        var genericAttribute = await _genericAttributeRepository.GetByIdAsync(id);
    ...
    {
        var genericAttribute = await _genericAttributeRepository.GetByIdAsync(model.Id);
