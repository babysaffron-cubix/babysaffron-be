...
public partial class TaxController : BaseNopWebApiBackendController
{
    ...
    public TaxController(IAttributeService<CheckoutAttribute, CheckoutAttributeValue> checkoutAttributeService,
        ...
        int customerId)
    {
        ...
        var checkoutAttributeValue =
            await _checkoutAttributeService.GetAttributeValueByIdAsync(checkoutAttributeValueId);
