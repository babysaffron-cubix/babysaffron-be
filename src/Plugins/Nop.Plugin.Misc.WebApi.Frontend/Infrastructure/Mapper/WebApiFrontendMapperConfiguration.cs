...
public partial class WebApiFrontendMapperConfiguration : BaseMapperConfiguration
{
    ...
    {
        CreateDtoMap<ProductDetailsModel, ProductDetailsModelDto>(dtoMappingExpression: map =>
        ...
        CreateDtoMap<CategorySimpleModel, CategorySimpleModelDto>(dtoMappingExpression: map =>
    ...
    {
        CreateDtoMap<PasswordRecoveryModel, PasswordRecoveryModelDto>(dtoMappingExpression: map =>
        {
    ...
    protected virtual void CreateCheckoutMaps()
    {
        ...
        CreateDtoMap<CheckoutPaymentInfoModel, CheckoutPaymentInfoModelDto>(entityMappingExpression: map =>
            map.ForMember(m => m.PaymentViewComponent, options => options.Ignore()));
        CreateDtoMap<CheckoutConfirmModel, CheckoutConfirmModelDto>(
            entityMappingExpression: map => map.ForMember(m => m.DisplayCaptcha, options => options.Ignore()),
            dtoMappingExpression: map =>
